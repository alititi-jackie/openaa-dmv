...
export default function StateHero({ state }: { state: DmvState }) {
  ...
  const isVerifiedState = isCalifornia || isPennsylvania || isMassachusetts || isWashington
  const summary = isCalifornia
    ...
    : isPennsylvania
      ...
      : isMassachusetts
        ...
        : isWashington
          ? '面向准备 Washington DOL Driving Knowledge Exam 的用户，提供华州专属考点、中文 / English / 中英对照题库、40 题模拟考试、交通标志和错题复习。'
          : state.summary
  const examRule = isCalifornia
    ...
    : isPennsylvania
      ...
      : isMassachusetts
        ...
        : isWashington
          ? 'Washington DOL Driving Knowledge Exam 共 40 题。'
          : state.examRule
  const passRule = isCalifornia
    ...
    : isPennsylvania
      ...
      : isMassachusetts
        ...
        : isWashington
          ? '至少答对 32 题通过；及格成绩有效 2 年，官方考试支持简体中文、繁体中文和 English 等语言。'
          : state.passRule
