...
const V: Record<string, SignMeta> = {
  ...
  'signs-003': visual('w1-2-curve.svg', '弯道警告标志', 'W1-2'),
  'signs-004': visual('r2-1-speed-limit.svg', 'SPEED LIMIT 限速标志', 'R2-1'),
  'signs-005': visual('cw20-1-road-work.svg', 'ROAD WORK 道路施工标志', 'W20-1'),
  'signs-006': visual('w10-1-railroad-warning.svg', '铁路道口预警标志', 'W10-1'),
  'signs-007': visual('d1-guide-example.svg', '绿色导向标志', 'Guide sign', 'MUTCD 导向标志学习图'),
  ...
  'ca-signs-003': visual('w1-2-curve.svg','弯道警告标志','W1-2'),
  'ca-signs-004': visual('cw20-1-road-work.svg','道路施工标志','W20-1'),
  'ca-signs-005': visual('s1-1-school.svg','学校区域标志','S1-1'),
  'ca-signs-006': visual('w10-1-railroad-warning.svg','铁路道口预警标志','W10-1'),
  'ca-signs-007': visual('r2-1-speed-limit.svg','限速标志','R2-1'),
  'ca-signs-008': visual('d1-guide-example.svg','绿色导向标志','Guide sign','MUTCD 导向标志学习图'),
  'ca-signs-009': visual('d9-2-hospital.svg','医院服务标志','D9-2'),
  'ca-signs-010': visual('figure-2m-2-recreation-guide.svg','棕色休闲文化导向标志','Chapter 2M','MUTCD 休闲文化导向标志学习图'),
  'ca2-signs-001': visual('r1-1-stop.svg','STOP 停车标志','R1-1'),
  'ca2-signs-002': visual('r1-2-yield.svg','YIELD 让行标志','R1-2'),
  'ca2-signs-003': visual('w1-2-curve.svg','弯道警告标志','W1-2'),
  'ca2-signs-004': visual('cw20-1-road-work.svg','道路施工标志','W20-1'),
  'ca2-signs-005': visual('r2-1-speed-limit.svg','限速标志','R2-1'),
  'ca2-signs-006': visual('d1-guide-example.svg','绿色导向标志','Guide sign','MUTCD 导向标志学习图'),
  'ca2-signs-007': visual('d9-2-hospital.svg','医院服务标志','D9-2'),
  'ca2-signs-008': visual('figure-2m-2-recreation-guide.svg','棕色休闲文化导向标志','Chapter 2M','MUTCD 休闲文化导向标志学习图'),
  ...
  'ca2-signs-015': visual('figure-3b-only-arrow.svg','ONLY 与方向箭头路面标线','Part 3B','MUTCD 路面标线学习图'),
  'ca2-signs-016': visual('figure-3b-yellow-center-lines.svg','黄色中心线标线','Part 3B','MUTCD 路面标线学习图'),
  ...
  'ca2-signs-020': visual('w1-2-curve.svg','弯道警告标志','W1-2'),
}
...
export default function QuestionSignImage({ question, stateSlug, large=false }: { question:DmvQuestion; stateSlug?:string; large?:boolean }) {
  ...
  // California and New Jersey use these standard U.S. MUTCD sign assets.
