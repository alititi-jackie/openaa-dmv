...
export const trafficSignLibrary: Record<string, TrafficSignAsset> = {
  ...
  'R3-2': asset('R3-2', `${COMMON}/r3-2-no-left-turn.svg`, 'NO LEFT TURN 禁止左转标志', 'R3-2', 'MUTCD 标准标志'),
  ...
  'W6-2': asset('W6-2', `${COMMON}/w6-2-divided-highway-ends.svg`, 'DIVIDED HIGHWAY ENDS 分隔公路结束标志', 'W6-2', 'MUTCD 标准标志'),
  'W6-3': asset('W6-3', `${COMMON}/w6-3-two-way-traffic.svg`, 'TWO-WAY TRAFFIC 双向交通标志', 'W6-3'),
  'W7-1': asset('W7-1', `${COMMON}/w7-1-hill.svg`, 'HILL 陡坡警告标志', 'W7-1', 'MUTCD 标准标志'),
