...
const QUESTION_SIGN_KEYS: Record<string, string> = {
  'signs-001': 'R1-1','signs-002': 'R1-2','signs-003': 'W1-2','signs-004': 'R2-1','signs-005': 'W20-1','signs-006': 'W10-1',
...
const CUSTOM_VISUALS: Record<string, SignMeta> = {
  ...
  'ny-openaa-15': custom('d9-2-hospital.svg','HOSPITAL 医院服务标志','D9-2','交通标志学习图'),
}
