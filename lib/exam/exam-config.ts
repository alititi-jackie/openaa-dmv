...
const CONFIGS: Record<string, StateExamConfig> = {
  ny:{ stateSlug:'ny', agencyLabel:'NY DMV', defaultModeId:'standard-20', modes:[{ id:'standard-20', label:'New York DMV 20题模拟考试', description:'按 NY DMV Class D/DJ/E learner permit 笔试标准：20题，至少答对14题；正式考试包含4道交通标志题，其中至少答对2道。', size:20, passingCorrect:14, ruleStatus:'verified', quotas:{ rules:10,safety:6,signs:4 } }] },
  ...
  florida:{ stateSlug:'florida', agencyLabel:'FLHSMV', defaultModeId:'standard-50', modes:[{ id:'standard-50', label:'Florida Class E 50题模拟考试', description:'按 Florida Class E Knowledge Exam 的 50 题格式练习；本站以 80% 作为通过线，并按 60 分钟在线考试时限模拟。', size:50, passingCorrect:40, passingPercent:80, ruleStatus:'verified', quotas:{ rules:24,safety:16,signs:10 } }] },
}
