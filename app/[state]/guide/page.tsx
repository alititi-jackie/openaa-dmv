...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isCalifornia ? '2026 加州 DMV 驾照笔试与 Permit 考试指南' : isPennsylvania ? '2026 宾州 PennDOT 驾照笔试指南｜18题答对15题通过' : isMassachusetts ? '2026 麻州 RMV Permit 考试指南｜25题答对18题通过' : `${state.nameZh} DMV 驾照考试指南`
