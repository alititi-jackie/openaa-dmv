...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: isCalifornia ? '加州 DMV 中文驾照考试指南：California Driver’s Handbook、中文 Class C 样题、Permit 申请、知识考试、练习与路考准备。' : stateDescription(state),
    ...
    ? [
        {
          ...
          answer: '优先阅读 California DMV 官方 Driver’s Handbook。官方提供中文 PDF；本站题库适合用来理解和复习常见知识点。',
        },
        {
